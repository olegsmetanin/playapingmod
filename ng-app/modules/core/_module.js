    ...
    .config(['$routeProvider', '$locationProvider', '$stateProvider', '$urlRouterProvider',
        function($routeProvider, $locationProvider, $stateProvider, $urlRouterProvider) {
            ...
            var page1C = {
                name: "page1C",
                abstract: true,
                templateUrl: '/ng-app/modules/core/masterpages/page1C.tpl.html'
            },
                page2C = {
                    name: "page2C",
                    abstract: true,
                    templateUrl: '/ng-app/modules/core/masterpages/page2C.tpl.html'
                },
                tabPage1C = {
                    name: "tabPage1C",
                    abstract: true,
                    templateUrl: '/ng-app/modules/core/masterpages/tabPage1C.tpl.html'
                },
                tabPage2C = {
                    name: "tabPage2C",
                    abstract: true,
                    templateUrl: '/ng-app/modules/core/masterpages/tabPage2C.tpl.html'
                };
