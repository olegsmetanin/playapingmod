    ...
    .config(['$routeProvider', '$locationProvider', '$stateProvider', '$urlRouterProvider',
        function($routeProvider, $locationProvider, $stateProvider, $urlRouterProvider) {
            ...
            var projectsList = {
                ...
                views: {
                    'sidebar': {
                        templateUrl: '/ng-app/modules/home/projects/listview/projectsListFilter.tpl.html'
                    },
                    'content': {
                        templateUrl: '/ng-app/modules/home/projects/listview/projectsListGrid.tpl.html'
                    }
                }
            };
        ...
        function($scope, $projectsService, $pageConfig) {
            ...
            $scope.templatesConfig = function(projectId) {
                if (projectId && projectId.indexOf('play') >= 0) {
                    return '/ng-app/modules/home/projects/listview/details/playProjectDetails.tpl.html';
                } else {
                    return '/ng-app/modules/home/projects/listview/details/otherProjectDetails.tpl.html';
                }
            };
